class ApiHelper {
  static final String domain = "http://192.168.1.9:8000";//update
  ...
  static final String jsCheckIfAppliedForJob = baseurl + "/jobseeker/job/check-if-already-applied";
  //EM
  ...
  static final String emAppliedJobseekers = baseurl + "/employer/job/applied-jobseekers";
